    ...
    var updateData = function(container, nodes, links) {
        ...
        linkSelection.enter().append("path")
            .attr("class", function(d){
                if(d.source.name=="VirtualRoot") return "virtual-link";
                else return "link";
            })
            .attr("d",diagonal);
        ...
        node.append("circle")
            ...
            .style('stroke', function(d) {
                if(d.name=="VirtualRoot"){
                return d3.scale.linear()
                    .domain([1, 0])
                    .range(["white", "white"])(typeof d.satisfaction !== "undefined" ? d.satisfaction : 1);
                }
                else
                {
                    return d3.scale.linear()
                    .domain([1, -1])
                    .range(["red", "green"])(typeof d.satisfaction !== "undefined" ? d.satisfaction : 1);
                }
      ...
      //      .attr("transform", function(d) { return d.x < 180 ? "translate(8)" : "rotate(180)translate(-8)"; })
            .attr("transform", function(d) { return "rotate(30)translate(8)";})
            .text(function(d) {
                if(d.name=="VirtualRoot") return "";
                else return d.name;
            });
    };
